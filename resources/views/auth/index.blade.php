    ...
    <main class="page-wrapper">
      <section class="panel left-panel">
        <header class="left-header">
          <img src="assets/logo-simora.png" alt="SIMORA" class="logo-simora">
        </header>
        ...
        <div class="left-content">
          ...
          <div class="org-logos">
            <div class="logo-circle logo-mpk">
              <img src="assets/mpk.png" alt="MPK">
            </div>

            <div class="logo-row">
              <div class="logo-circle logo-osis">
                <img src="assets/osis.png" alt="OSIS">
              </div>
              <div class="logo-circle logo-school">
                <img src="assets/sangtasih.png" alt="Sekolah">
              </div>
            </div>
          </div>
        </div>
