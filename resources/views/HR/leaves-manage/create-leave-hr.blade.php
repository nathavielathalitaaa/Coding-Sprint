...
@section('content')
        ...
        <div class="flex flex-col gap-2 py-4 md:flex-row md:items-center print:hidden">
            <div class="grow">
                <h5 class="text-xl font-bold text-slate-900">Add Leave (HR)</h5>
            </div>
            <ul class="flex items-center gap-2 text-sm font-normal shrink-0">
                <li class="text-slate-400">
                    <a href="#!">Leaves Manage</a>
                </li>
                <li class="text-slate-700 font-medium">/ Add Leave (HR)</li>
            </ul>
        </div>
                    ...
                    <form id="applyLeave" action="{{ route('hr/create/leave/employee/save') }}" method="POST">
                        ...
                        <div class="grid grid-cols-1 gap-6 md:grid-cols-2 xl:grid-cols-12">
                            <div class="xl:col-span-6">
                                <div>
                                    <label for="employee_name" class="block mb-2 text-sm font-bold text-slate-700">Employee</label>
                                    <select name="employee_name" id="employee_name" class="w-full px-4 py-2 rounded-xl border border-gray-200 bg-white focus:ring-2 focus:ring-[#80BB9B] focus:outline-none shadow-sm" data-choices="">
                            ...
                            <div class="xl:col-span-6">
                                <div>
                                    <label for="employeeId" class="block mb-2 text-sm font-bold text-slate-700">Employee ID</label>
                                    <input type="text" id="employeeId" class="w-full px-4 py-2 rounded-xl border border-gray-200 bg-slate-50 text-slate-600 shadow-sm" readonly>
                                </div>
                            </div>
