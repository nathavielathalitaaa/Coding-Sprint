...
<div class="flex items-center justify-between py-4">
    <div>
        <h5 class="text-base font-bold text-slate-900">Pengaturan Dokumen TTD</h5>
        <p class="text-xs text-slate-500 mt-0.5">Atur logo, nama perusahaan, warna, dan font untuk dokumen yang digenerate sistem.</p>
    </div>
</div>
    ...
    <div class="lg:col-span-2">
        <form action="{{ route('hr.settings.document.update') }}" method="POST">
            ...
            <div class="ds-section">
                ...
                <div class="mb-4">
                    <label class="block text-xs font-bold text-slate-600 mb-1">Nama Perusahaan <span class="text-red-500">*</span></label>
                ...
                <div class="grid grid-cols-2 gap-4 mb-4">
                    <div>
                        <label class="block text-xs font-bold text-slate-600 mb-1">Warna Aksen (Hex) <span class="text-red-500">*</span></label>
                ...
                <div class="mb-5">
                    <label class="block text-xs font-bold text-slate-600 mb-1">Teks Footer (Opsional)</label>
    ...
    <div class="lg:col-span-1">
        <div class="ds-section">
            <div class="flex items-center gap-2 mb-4 pb-2 border-b border-slate-100">
                ...
                <h6 class="text-sm font-bold text-slate-900">Logo Dokumen</h6>
            </div>
            ...
            <form action="{{ route('hr.settings.document.logo') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-4">
                    ...
                    <p class="text-[10px] text-slate-400 mt-1">Format: PNG, JPG (Maks 2MB)</p>
